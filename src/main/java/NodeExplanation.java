		...
		switch(node) {
			...
			case infocb:
				return "With the 'Info Mode' checkbox selected, you can click on anything (a button, textbox, or "
						...
						+ "to the right.\n\n"
						+ "A couple good things to load are given here:\n\n"
						+ "Choi's example: \n"
						+ "(146.17500000000004, -97.449999999999974)\n"
						+ "(-0.122803613107147, 9.72780049541614)\n"
						+ "(1.041521415726032, -15.728600754675153)\n"
						+ "(-0.569207544358904,-14.003111131169842)\n\n"
						+ "Our minimially axial construction, with epsilon=0.0897\n"
						+ "(3.9170254990342483, -30.888044023482998)\n"
						+ "(-3.9170254990342483, -30.888044023482998)\n"
						+ "(144.97474683058323, 0.0)\n"
						+ "(0.0, 13.0)\n\n"
						+ "Our minimially axial construction, with epsilon=0.0345\n"
						+ "(-0.587362742573467, -12.042419499840801)\n"
						+ "(0.587362742573467, -12.042419499840801)\n"
						+ "(144.97474683058323, 0.0)\n"
						+ "(0,5)\n\n"
						+ "A fairly asymmetric yet relatively low eccentricity pentagon\n"
						+ "(1.4345046187914599, 24.04008620339733)\n"
						+ "(4.8525831708806715, -59.77857328658926)\n"
						+ "(-5.077758968029796, -24.36002619389314)\n"
						+ "(316.49534766537084, -24.78860196145842)\n"
						+ "(314.3778831482469, 24.53999093861307)";
